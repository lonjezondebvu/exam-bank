    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Class Schedule </a>
            </div>
                    ...
                    <div class="col-md-5 well">
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from classsched where classid='$get_id'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
while($CYS_row=mysqli_fetch_array($CYS_query)){
 ...
 $query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and fname='$fname'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
 $query1= mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and fname='$fname'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			echo "<script>alert('Course already exist');</script>";
                                ...
                                mysqli_query($GLOBALS["___mysqli_ston"], "update classsched set day ='$day', time_start ='$time_start',
		 time_end ='$time_end', fname ='$fname', subject_code ='$subject_code', room_name='$room_name', course_year_section ='$course_year_section', semester ='$semester', sy ='$sy' where classid = '$get_id'") or die(mysql_query());
                             echo"Saved";
                            }
							}
                            ?>
