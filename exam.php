    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#	">Exam Schedule
            </div>
						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from examsched where department like '%CIT%' and status like '%unsaved%' order by examid DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                                    while ($row = mysqli_fetch_array($query)) {
                                        $id = $row['examid'];
										
																
										$query1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT *FROM examsched where department like '%CIT%' and status like '%unsaved%' order by examid DESC");
