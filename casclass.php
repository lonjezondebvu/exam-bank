...
<body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
					...
					<?php include ('modal_add_class2.php');?>
  ...
  <strong><i class="icon-user icon-large"></i>Class Schedule</strong>                                    
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from classsched where department like '%SAS%' order by classid DESC") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                                    while ($row = mysqli_fetch_array($query)) {
                                        $id = $row['classid'];
										
																
										$query1 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT *FROM classsched where department like '%SAS%' order by classid DESC");
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="160">
                                                <a href="#delete_class2<?php echo $id; ?>" role="button"  data-target = "#delete_product<?php echo $id;?>"data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                                <a href="edit_class.php<?php echo '?id=' . $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
                                            <!-- product delete modal -->
                                   <?php include ('delete_class_modal2.php');?>
                                    <!-- end delete modal -->
