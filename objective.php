						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
									...
									Topic</strong>
									<a href="forcourse.php<?php echo '?id=' . $get_id; ?>" >
					...
					$query2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from question where objective='$id2'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
                                       ...
                                       $totalRows_Recordset1 = mysqli_num_rows($query2);					
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="25%">
											<a href="forquestion.php<?php echo '?id=' . $id2; ?>" class="btn btn-primary btn-lg" style="height:35px; padding-top:6px; font-size:14px;">Questions(<?php echo $totalRows_Recordset1; ?>)</a>
                                                ...
                                                <a href="edit_objective.php<?php echo '?id=' . $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
