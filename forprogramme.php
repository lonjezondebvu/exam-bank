			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
							 ...
							 <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal<?php echo $get_id = $_GET['id']; ?>" >
                              Add Subject
                            </button>
						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Programs Offered by the  <?php echo $_GET['id']; ?> Department 
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="25%">
                                                ...
                                                <a href="edit_programme.php<?php echo '?id=' . $id2; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
                                            <!-- product delete modal -->
                                   <?php include ('delete_programme_modal.php');?>
                                    <!-- end delete modal -->
