<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <form  method="post" enctype="multipart/form-data">
                                ...
                                <hr>
								 ...
								 <div class="control-group">
                                           ...
                                           <input type="text" name="subject_code" class = "form-control" placeholder="Subject">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class = "form-control"  name="subject_title"  placeholder="Title" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="subject_category" class = "form-control" placeholder="Category">
                                    </div>
                                </div>
								  <div class="control-group">
                            ...
                            if (isset($_POST['go'])) {
                                ...
                                mysqli_query($GLOBALS["___mysqli_ston"], "insert into subject (subject_code,subject_title,subject_category,semester,department)
