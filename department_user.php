						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Department
                                </div>
                                <thead>
                                    <tr>
										<th>Department</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        ?>
                                        <tr class="warning">
                                            <td><?php echo $row['department']; ?></td><td><?php echo $row['faculty']; ?></td> 											                                           
                                            <td width="25%">
                                                ...
                                                <a href="edit_department_user.php<?php echo '?id=' . $id2; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
                                            <!-- product delete modal -->
                                   <?php include ('delete_department_modal_user.php');?>
                                    <!-- end delete modal -->
