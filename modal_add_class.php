		...
		<option value="8:30pm">8:30pm</option></select>
								 ...
								 <div class="control-group">
									...
									<select type="text" name="fname" class = "form-control"  >
                                      <option>--Select--</option>
	<?php $teacher_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from teachers where department like '%CIT%'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	<?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="subject_code" class = "form-control"  >
                                       <option>--Select--</option>
<?php $subject_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from subject where department like '%CIT%'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
 ...
 <?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="room_name" class = "form-control"  >
                                        <option>--Select--</option>
	<?php $room_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from room where department like '%CIT%'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	<?php } ?>
								  ...
								  <div class="control-group">
									...
									<select type="text" name="course_year_section" class = "form-control" >
                                       <option>--Select--</option>
	<?php $CYS_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from course where department like '%CIT%'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
while($CYS_row=mysqli_fetch_array($CYS_query)){
	...
	<?php $sy_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from sy")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
$Saturday=$_POST['Saturday'];
			...
			$query1= mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and fname='$fname'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
			$query2 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and room_name='$room_name'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
			$query3 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and course_year_section='$course_year_section'") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
			$query4 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' ") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			echo "<script>alert('Conflict In time');</script>";
                                ...
                                mysqli_query($GLOBALS["___mysqli_ston"], "insert into classsched (classid,day,time_start,time_end,fname,subject_code,room_name,course_year_section,semester,sy,department,status)
