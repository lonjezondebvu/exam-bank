						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>School Name</strong>
                                </div>
                                <thead>
                                    <tr>
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="25%">
                                                ...
                                                <a href="edit_faculty.php<?php echo '?id=' . $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
