<div class="modal fade" id="room1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <form id="save_voter" class="form-horizontal" method="POST" action="preview5.php">	
