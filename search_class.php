...
<hr>
   ...
   <select name="course_year_section" class="span333">
	...
	<?php $room_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from classsched")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
while($room_row=mysqli_fetch_array($room_query)){
	?>
	<option><?php echo $room_row['course_year_section']; ?></option>
	<?php } ?>
	</select>
    </div>
    </div>
