            ...
            <div id="page-inner">
			 <div class="row">
                    <div class="col-md-12">
						...
						<?php include ('modal_add_question.php');?>
						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;<a href="school.php" >School</a>
									/<a href="department.php<?php echo '?id=' . $get3; ?>" >Department</a>
									/<a href="forcourse.php<?php echo '?id=' . $get; ?>" >Subject</a>
									/<a href="objective.php<?php echo '?id=' . $id; ?>" >Topic</a>/Question
									
									<a href="objective.php<?php echo '?id=' . $id; ?>" >
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="160">
                                                ...
                                                <a href="edit_question.php<?php echo '?id=' . $id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;Edit</a>
                                            </td>
