<div class="modal fade" id="reports1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <form id="save_voter" class="form-horizontal" method="POST" action="preview7.php">	
   ...
   <select name="course_year_section" class="span333">
	...
	<?php $room_query=mysqli_query($GLOBALS["___mysqli_ston"], "select * from course")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
